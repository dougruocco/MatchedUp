...
-(void)queryForCurrentPhotoIndex
{
    if ([self.photos count] > 0){
        ...
        PFQuery *likeAndDislikeQuery = [PFQuery orQueryWithSubqueries:
        @[queryForLike, queryForDislike]];
...
- (void)updateView
{
    self.firstNameLabel.text = self.photo[kCCPhotoUserKey][kCCUserProfileKey][kCCUserProfileKey];
...
#pragma mark - CCProfileViewControllerDelegate
